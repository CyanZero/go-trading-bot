...
/*
MarketApiService Retrieve market depth information (Order book) for given symbol
 ...
 * @param symbol pair id to retrieve market depth
@return Depth
*/
func (a *MarketApiService) DpGet(ctx context.Context, symbol string) (Depth, *http.Response, error) {
	var (
		...
		localVarReturnValue  Depth
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp"
...
/*
MarketApiService Provides information about market summaries for symbols.
...
*/
func (a *MarketApiService) GetmarketsummariesGet(ctx context.Context) (MarketSummariesResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  MarketSummariesResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/getmarketsummaries"
	...
	if localVarHttpResponse.StatusCode >= 200 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketSummariesResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				log.Printf("What we have here %s", newErr.error)
				return localVarReturnValue, localVarHttpResponse, newErr
			}
			newErr.model = v
			log.Printf("What we have here %+v", v)
			return localVarReturnValue, localVarHttpResponse, newErr
		}
		if localVarHttpResponse.StatusCode == 400 {
			var v ErrorResponse
...
/*
MarketApiService Retrieve market information  for given symbol
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param symbol pair id to retrieve market information.
@return TradeHistoryResponse
*/
func (a *MarketApiService) HtGet(ctx context.Context, symbol string) (TradeHistoryResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ht"
...
/*
MarketApiService Retrieves market price information
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MarketPriceGetOpts - Optional Parameters:
 * @param "Symbol" (optional.String) -  Retrieves market-price for all symbols if symbol is not provide in parameter otherwise retrieves information for symbol provided in
@return []MarketPrice
*/

type MarketPriceGetOpts struct {
	Symbol optional.String
}

func (a *MarketApiService) MarketPriceGet(ctx context.Context, localVarOptionals *MarketPriceGetOpts) ([]MarketPrice, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []MarketPrice
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/market-price"

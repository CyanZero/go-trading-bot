...
type ServerInformationApiService service

/*
ServerInformationApiService Test connectivity to API
Test connectivity to API.  Example URL: https://trade.coss.io/c/api/v1/ping
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ServerStatusInfo
*/
func (a *ServerInformationApiService) PingGet(ctx context.Context) (ServerStatusInfo, *http.Response, error) {
	var (
		...
		localVarReturnValue  ServerStatusInfo
	)
...
/*
ServerInformationApiService Test connectivity to API and get Server time
Test connectivity to API and get server time.  Example URL: https://trade.coss.io/c/api/v1/time
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ServerTimeInfo
*/
func (a *ServerInformationApiService) TimeGet(ctx context.Context) (ServerTimeInfo, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ServerTimeInfo
	)

...
type ExchangeInformationApiService service

/*
ExchangeInformationApiService Provides information about trading rules, symbols etc.
...
@return ExchangeInfo
*/
func (a *ExchangeInformationApiService) ExchangeInfoGet(ctx context.Context) (ExchangeInfo, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/exchange-info"
